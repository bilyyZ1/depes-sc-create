...
try:
    ...
    nama_file = input("\033[93m[+] Nama File Output (contoh: deface.html): \033[0m")

    # Cek apakah background video
    is_video = any(ext in bg_url.lower() for ext in ['.mp4', '.webm', 'youtube.com', 'youtu.be'])
